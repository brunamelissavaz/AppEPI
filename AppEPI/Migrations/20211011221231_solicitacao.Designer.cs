...
namespace AppEPI.Migrations
{
    ...
    [Migration("20211011221231_solicitacao")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MotivoSolicitacaoProduto", b =>
                {
                    b.Property<int>("MotivosCodigo")
                        .HasColumnType("int");

                    b.Property<int>("SolicitacaoProdutosCodigoProduto")
                        .HasColumnType("int");

                    b.Property<int>("SolicitacaoProdutosCodigoSolicitacao")
                        .HasColumnType("int");

                    b.HasKey("MotivosCodigo", "SolicitacaoProdutosCodigoProduto", "SolicitacaoProdutosCodigoSolicitacao");

                    b.HasIndex("SolicitacaoProdutosCodigoProduto", "SolicitacaoProdutosCodigoSolicitacao");

                    b.ToTable("MotivoSolicitacaoProduto");
                });
            ...
            modelBuilder.Entity("MotivoSolicitacaoProduto", b =>
                {
                    b.HasOne("AppEPI.Entidades.Motivo", null)
                        .WithMany()
                        .HasForeignKey("MotivosCodigo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AppEPI.Entidades.SolicitacaoProduto", null)
                        .WithMany()
                        .HasForeignKey("SolicitacaoProdutosCodigoProduto", "SolicitacaoProdutosCodigoSolicitacao")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
